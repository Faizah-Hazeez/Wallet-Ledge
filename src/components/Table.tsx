...
function Table() {
  ...
  return (
    <table className="w-full border-separate border-spacing-y-3 border-spacing-x-3 mt-6 font-public">
      <thead className="">
      ...
      <tbody>
        {sortedData.map(({ id, date, remark, amount, currency, type }) => (
          <tr
            key={id}
            className="text-[13px] text-[#1B2528] text-left last:[&>td]:border-b-0"
          >
            <td className="border-b-[1.5px] border-[#49656E33] ">{date}</td>
            <td className="border-b-[1.5px] border-[#49656E33]">{remark}</td>
            <td className="border-b-[1.5px] border-[#49656E33] ">
              {formatAmount(amount)}
            </td>
            <td className="border-b-[1.5px] border-[#49656E33] ">{currency}</td>
            <td className="border-b-[1.5px] border-[#49656E33] pb-3">
